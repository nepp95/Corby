...
#define ENG_INTERNAL_ASSERT_NO_MSG(type, check) ENG_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", ENG_STRINGIFY_MACRO(check), ::Engine::Assert::currentFileName(__FILE__), __LINE__)
